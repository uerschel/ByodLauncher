    ...
    <v-container>
        ...
        <v-row>
            ...
            <v-col cols="12" sm="6" md="4">
                <v-card>
                    <v-img src="@/assets/images/configureSession.svg" height="180" contain/>
                    <v-card-title>Notebook checker</v-card-title>
                    <v-card-text>
                        Du bist dir nicht sicher, ob dein gewünschtes Notebook den Anforderungen an deinen Lehrberuf genügt?
                        Mit dem Notebook checker kannst du nach einem beliebigen Modell suchen und wir evaluieren, ob dieser
                        für dich geeignet ist.
                    </v-card-text>
                    <v-divider/>
                    <v-card-actions>
                        <v-spacer/>
                        <v-btn text small :to="{name: 'notebook checker'}">Notebook checker</v-btn>
                    </v-card-actions>
                </v-card>
            </v-col>
        </v-row>
